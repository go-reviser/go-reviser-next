...
export default function SignIn() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // Handle remember me functionality in local storage if needed
            if (rememberMe) {
    ...
    return (
        <div className="h-[calc(100vh-72px)] flex items-center justify-center">
            <div className="w-[65%] flex flex-col md:flex-row bg-white rounded-3xl shadow-lg">
                {/* Image Section */}
                <div className="hidden md:flex md:w-1/3 bg-white items-center justify-center p-8 rounded-l-3xl">
                    <div className="w-5/6">
                        <img
                ...
                {/* Form Section */}
                <div className="w-full md:w-2/3 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-8 rounded-3xl md:rounded-l-none">
